        ...
        return AlertDialog(
          ...
          content: Column(
            ...
            children: [
              ...
              const Text(
                  '• Save your account address - you will need to charge it with STRK tokens to participate in tournaments.'),
            ],
          ),
          actions: <Widget>[
            TextButton(
  ...
  Future<void> _createSponsoredAccount() async {
    try {
      ...
      final publicKey = BigInt.parse(
          ...
          radix: 16);
      final avnuProvider =
          getAvnuProvider(publicKey: publicKey, apiKey: apiKey);
              ...
              if (confirm == true) {
                try {
                  ...
                  if (mounted) {
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(
                        content: Text('Error removing accounts: $e'),
                      ),
                    );
                  }
                }
